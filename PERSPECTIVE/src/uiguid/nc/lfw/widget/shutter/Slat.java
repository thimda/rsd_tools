 ...
 * <b>Note:</b>
 * 		SWT.LEFT, SWT.RIGHT, 指定了SWT.CENTER属�?
 *      相当于指定控件为Tab
 * </pre>
 *
 * @author luma
...
public class Slat extends BaseComposite implements DisposeListener, PaintListener, ControlListener {	
	...
	/**
     * 计算截短的字符串，从中间�?��不断减少，中间填省略号，直到宽度合�?未知
     * 
     * @param gc
     * @param t
     * @param width
