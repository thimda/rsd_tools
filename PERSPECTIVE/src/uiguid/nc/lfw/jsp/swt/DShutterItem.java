...
public class DShutterItem extends DLayoutPanel {

	public DShutterItem(Composite parent, int style, UIElement element) {
...
//	}
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		...
		TextPropertyDescriptor idProp = new TextPropertyDescriptor(UIShutterItem.ID, "ID");
		idProp.setCategory("基本");
		al.add(idProp);
		
		TextPropertyDescriptor textProp = new TextPropertyDescriptor(UIShutterItem.TEXT, "TEXT");
		textProp.setCategory("基本");
		al.add(textProp);
		
		TextPropertyDescriptor i18nNameProp = new TextPropertyDescriptor(UIShutterItem.I18NNAME, "I18NNAME");
		i18nNameProp.setCategory("基本");
		al.add(i18nNameProp);
