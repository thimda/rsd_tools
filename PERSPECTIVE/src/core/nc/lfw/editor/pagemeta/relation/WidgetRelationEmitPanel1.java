...
/**
 * Widget连接器 触发时机构造向导 第一页内容
 * @author guoweic
 *
 */
public class WidgetRelationEmitPanel1 extends Canvas {
	...
	public WidgetRelationEmitPanel1(Composite parent, int style, WidgetElementObj sourceWidget) {
		super(parent, style);
