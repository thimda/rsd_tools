 ...
 *
 */
public class DatasetToFormConnFigure  extends PolylineConnection {
	...
	public DatasetToFormConnFigure(DatasetToFormConnection con) {
		super();
		this.con = con;
		...
		setForegroundColor(Display.getCurrent().getSystemColor(SWT.COLOR_MAGENTA));
	}
