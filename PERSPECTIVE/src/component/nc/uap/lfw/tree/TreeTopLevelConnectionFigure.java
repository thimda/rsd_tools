 ...
 *
 */
public class TreeTopLevelConnectionFigure extends ConnectionFigure {
	private Label lblCnnName = new Label();
	private Border border = new LineBorder(Display.getCurrent().getSystemColor(SWT.COLOR_DARK_MAGENTA));
	...
	public TreeTopLevelConnectionFigure(TreeTopLevelConnection con) {
		super(con);
		this.con = con;
