...
/**
 * Ds Relation Á¬½Ó Figure
 * @author zhangxya
 *
 */
public class DsRelationConnectionFigure extends PolylineConnection {
	private Label lblCnnName = new Label();
	private Border border = new LineBorder(Display.getCurrent().getSystemColor(SWT.COLOR_RED));
	private String errStr = null;
	
	private DsRelationConnection con = null;
	
	public DsRelationConnection getCon() {
		return con;
	}
	public void setCon(DsRelationConnection con) {
		this.con = con;
	}

	public DsRelationConnectionFigure(DsRelationConnection con) {
		super();
		this.con = con;
