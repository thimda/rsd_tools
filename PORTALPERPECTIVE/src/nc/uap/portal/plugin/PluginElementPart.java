 ...
 * @author dingrf
 */
public class PluginElementPart extends AbstractGraphicalEditPart implements
	...
	public static IFigure getFigureByModel(LFWBasicElementObj cell) {
		IFigure figure = null;
		if (cell instanceof PluginElementObj) {
			PluginElementObj plugin = (PluginElementObj) cell;
			figure = new PluginEleObjFigure(plugin);
		}
		return figure;
	}
	...
	public void propertyChange(PropertyChangeEvent event) {
		...
		if (PluginElementObj.PROP_PLUGIN_ELEMENT.equals(name)) {
			refreshChildren();
		}
	}
